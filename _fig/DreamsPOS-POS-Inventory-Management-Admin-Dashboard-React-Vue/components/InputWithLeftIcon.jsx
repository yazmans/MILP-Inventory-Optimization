// figma: 92:6859 Input with left icon (4 variants)
const __variants = {
  "property1=Input Select xs": { height: 53 },
  "property1=Input Select sm": { height: 57 },
  "property1=Input Select Default": { height: 63 },
};
const __vkey = (p) => "property1=" + p.property1;

export function InputWithLeftIcon(_p = {}) {
